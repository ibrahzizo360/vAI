...
export default function ClinicalNotesPage({ params }: ClinicalNotesPageProps) {
  ...
  const fetchNotes = async () => {
    try {
      ...
      const response = await fetchWithoutCache(
        `/api/patients/${patientId}/notes?limit=50`
      );
  ...
  const filteredNotes = notes.filter((note) => {
    ...
    const matchesFilter =
      filterType === "all" || note.encounter_type === filterType;
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {notes.length > 0
                      ? Math.round(
                          notes.reduce(
                            (sum, note) => sum + note.completeness_score,
                            0
                          ) / notes.length
                        )
                      : 0}
              ...
              <div className="flex gap-2">
                <Select value={filterType} onValueChange={setFilterType}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="family_meeting">
                      Family Meetings
                    </SelectItem>
                ...
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        ...
                        <p
                          className={`text-lg font-bold ${getCompletenessColor(
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-4">
                    <p className="text-sm text-gray-700 leading-relaxed">
                      ...
                      {((note.note_sections.assessment_plan?.length || 0) >
                        300 ||
                  ...
                  {/* Follow-up Items */}
                  {note.extracted_content.follow_up_items &&
                    note.extracted_content.follow_up_items.length > 0 && (
                      <div className="border-t pt-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {note.extracted_content.follow_up_items.length >
                            3 && (
